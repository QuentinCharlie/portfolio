...
const Contact = ({
  ...
  return (
    <ContactStyled>
      ...
      <div className="linkedin">You can get to me on <a href="https://www.linkedin.com/in/quentin-charlie/" target="_blank" rel="noopener noreferrer">Linkedin</a> <br /> or by filling this form below.</div>
